...
export const HARDCODED_NOTIFICATIONS: NotificationData[] = [
  {
    ...
    read: false,
    actionUrl: "/candidates/sarah-johnson",
  ...
  },
  {
    ...
    message: "Michael Chen moved from Screening to Interview stage",
    type: "candidate_moved",
    timestamp: getRandomDateTime(2),
    read: false,
    actionUrl: "/candidates/michael-chen",
    entityType: "candidate",
    entityId: "michael-chen",
    recipientId: "recruiter-1",
    priority: "High",
  },
  {
    ...
    message: "Technical interview scheduled with Emily Davis for tomorrow",
  ...
  },
  {
    id: "4",
    title: "Budget Alert",
    message: "Job posting budget for Senior Developer position is 80% used",
    type: "budget_exceeded",
    timestamp: getRandomDateTime(4),
    read: false,
    actionUrl: "/jobs/senior-developer",
    entityType: "budget",
    entityId: "job-1",
    recipientId: "recruiter-1",
    priority: "Medium",
  },
  {
    ...
    message: "Application deadline for UX Designer position ends in 3 days",
    type: "deadline_approaching",
    timestamp: getRandomDateTime(5),
    read: true,
    actionUrl: "/jobs/ux-designer",
    entityType: "deadline",
    entityId: "job-2",
    recipientId: "recruiter-1",
    priority: "High",
  ...
  },
  {
    ...
    message: "Follow up with candidates who haven't responded in 5 days",
    type: "reminder",
    timestamp: getRandomDateTime(7),
    read: true,
    actionUrl: "/follow-up",
    entityType: "other",
    entityId: "reminder-1",
  ...
  },
  {
    id: "8",
    title: "New Application Received",
    message: "David Kim applied for Product Manager position",
    type: "application_received",
    timestamp: getRandomDateTime(8),
    read: false,
    actionUrl: "/candidates/david-kim",
    entityType: "candidate",
    entityId: "david-kim",
    recipientId: "recruiter-1",
    priority: "Medium",
