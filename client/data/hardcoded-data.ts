...
export const HARDCODED_CANDIDATES: CandidateData[] = [
  {
    ...
    stageHistory: [
      ...
      },
      {
        ...
        notes: "Ready for next round, interviewer assigned",
        userId: "user_2",
        userName: "Sarah Kim",
        mailSent: true,
      },
  ...
  },
  {
    ...
    stageHistory: [
      ...
      },
      {
        ...
        duration: 6,
        reason: "Technical assessment scheduled",
        notes: "Case study presentation scheduled",
        userId: "user_2",
        userName: "Sarah Kim",
        mailSent: true,
      },
    ...
    emails: [
      {
        ...
        timestamp: getRandomDateTime(22),
        status: "sent",
        template: "application_received",
        openedAt: getRandomDateTime(21),
      },
    ],
    attachments: [
      {
